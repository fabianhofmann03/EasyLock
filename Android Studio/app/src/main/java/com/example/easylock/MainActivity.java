...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_messages, R.id.nav_terminal, R.id.nav_devices, R.id.nav_settings)
        ...
        //Snackbar.make(binding.getRoot(), Integer.toString(menuItem.getItemId()), 5000).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if(sharedPreferences.getBoolean("settings_start_automatic_connection", false) && bluetooth_check() && Bluetooth.getBluetoothDevice() != null) {
            ...
            case R.id.connect_btn:
                ...
                if (bluetooth_check()) {
                    ...
                    if (Bluetooth.getBluetoothDevice() == null) {
                        Snackbar.make(binding.getRoot(), getResources().getString(R.string.bluetooth_device_message), 5000).show();
                    } else {
